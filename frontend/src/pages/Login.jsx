...
const Login = () => {
    ...
    const [error, setError] = useState(''); // <--- THIS WAS CAUSING THE REFERENCE ERROR IF MISSING
                ...
                <div className="p-8 md:p-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className={`w-full py-4 rounded-xl font-bold text-white shadow-lg shadow-indigo-500/30 transition-all transform hover:-translate-y-1 active:scale-95 ${isLoading ? 'bg-slate-400 cursor-not-allowed' : 'bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700'}`}
                        >
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-slate-500 text-sm">New to SkillSync?{' '}
